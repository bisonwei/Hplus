$(function(){
	...
	var t=echarts.init(document.getElementById("echarts-bar-chart")),
		...
		series:[{
				...
				{	name:"降水量",
					type:"bar",data:[2.6,5.9,9,26.4,28.7,70.7,175.6,182.2,48.7,18.8,6,2.3],
					markPoint:{
	...
	h={title:{text:"预算 vs 开销",subtext:"纯属虚构"},
		...
		polar:[{indicator:[{text:"销售",max:6e3},
							{text:"管理",max:16e3},
							{text:"信息技术",max:3e4},
							{text:"客服",max:38e3},
							{text:"研发",max:52e3},
		...
		series:[{name:"预算 vs 开销",
				type:"radar",
				data:[{value:[4300,1e4,28e3,35e3,5e4,19e3],name:"预算分配"},
	...
	c={title:{text:"iphone销量",subtext:"纯属虚构",x:"center"},
...
/*
	...
	p={title:{text:"人物关系：乔布斯",subtext:"数据来自人立方",x:"right",y:"bottom"},
		...
		series:[{type:"force",
				...
				scaling:1.1,
				roam:"move",
				nodes:[{category:0,name:"乔布斯",value:10},
...
*/
	...
	series:[{name:"速度",
			...
			endAngle:45,
			splitNumber:2,
			axisLine:{lineStyle:{color:[[.2,"#ff4500"],
										[.8,"#48b"],
										[1,"#228b22"]
								],
								width:8
