...
$(function(){{
	var e=[
		{label:"数据 1",ata:21,color:"#d3d3d3"},
		{label:"数据 2",data:3,color:"#bababa"},
		{label:"数据 3",data:15,color:"#79d2c0"},
		{label:"数据 4",data:52,color:"#1ab394"}];
	$.plot(
			$("#flot-pie-chart"),
			e,
			{series:{pie:{show:!0}},
...
$(function(){
	...
	var l=$.plot(o,
				...
				{grid:{color:"#999999",
								...
								markings:function(e){
									for(var o=[],t=e.xaxis,i=Math.floor(t.min);i<t.max;i+=2*t.tickSize)
										o.push({xaxis:{from:i,to:i+t.tickSize},color:"#fff"});
										return o
								}},
							colors:["#1ab394"],
